...
public class BlockDrops extends LootTables {
    ...
    protected void addTables() {
        ...
        Content.ROYAL_GOLD.ifPresent(gold ->
    ...
    public static void lootLoaded(LootTableLoadEvent event) {
        ...
        new HashMap<ResourceLocation,ResourceLocation>() {{
            ...
            Content.ROYAL_GOLD.map(ForgeRegistryEntry::getRegistryName).ifPresent(r  -> put(Blocks.field_235387_nA_.getLootTable(), extend("block/", r)));
